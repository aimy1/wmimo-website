...
(function() {
  ...
  const translations = {
    zh: {
      ...
      // Community & Sponsor Page (Tsundere Edition)
      'community.hero_badge': '(⁄ ⁄•⁄ω⁄•⁄ ⁄) 傲娇开发者的秘密补给站',
      'community.hero_title': '哼，才……才不是特意求你赞助呢！',
      'community.hero_subtitle': '（扭头）就算你不投喂咖啡，Wmimo 也……也会一直开源免费维护下去的啦！但如果你非要请客的话……我也不是不能勉强收下啦！',
      'community.dialogue_name': '傲娇开发者 · 戳我试试',
      'community.btn_poke': '👉 戳一下',
      'community.sponsor_title': '💖 投喂通道（悄悄收下）',
      'community.sponsor_desc': '如果 Wmimo 真的有帮到你（才不信呢），欢迎请作者喝杯咖啡，给开源开发加点动力……笨蛋！',
      'community.crypto_currency': '<span>币种：<code>USDT</code></span> <span>·</span> <span>网络：<code>APTOS</code> (超低手续费)</span>',
      'community.btn_copy_addr': '复制地址',
      'community.addr_copied': '（脸红）收到啦……才没有很开心呢！',
      'community.dev_email_label': '📬 开发者联系邮箱：',
      'community.btn_send_email': '发送邮件',
      'community.tiers_title': '☕ 投喂能量段位表',
      'community.tier1_name': '1 杯冰美式',
      'community.tier1_price': '约 1.5 USDT',
      'community.tier1_buff1': '⚡ Bug 修复速度 +20%',
      'community.tier1_buff2': '🧊 傲娇度 -5%',
      'community.tier1_quote': '“喝了这杯咖啡，今晚就加急修一个 Bug 好啦……”',
      'community.tier2_name': '1 杯波霸奶茶',
      'community.tier2_price': '约 3.0 USDT',
      'community.tier2_buff1': '🚀 多平台打包动力 +50%',
      'community.tier2_buff2': '✨ 掉落隐藏更新与新特性',
      'community.tier2_quote': '“才不是喜欢甜的呢！只是……大脑写代码需要糖分！”',
      'community.tier3_name': '豪华下午茶套餐',
      'community.tier3_price': '约 10.0 USDT',
      'community.tier3_buff1': '💖 全天心率平稳，不写屎山代码',
      'community.tier3_buff2': '🌟 解锁作者超级感激与心愿清单',
      'community.tier3_quote': '“呜哇……真、真的请这么多吗？！谢、谢谢你啦……”',
      'community.qa_title': '💬 傲娇问答小剧场',
      'community.q1_title': '赞助了会有专属特权或去广告吗？',
      'community.q1_ans': '并·没·有！Wmimo 永远 100% 纯净开源无广告！所有人一视同仁！……不过作者会在心里悄悄给你画个小红心啦。',
      'community.q2_title': '为什么选 Aptos 网络的 USDT 呀？',
      'community.q2_ans': '因为 Aptos 转账手续费只要 0.0001 美元，便宜到可以忽略不计！才不想让你花冤枉的手续费给矿工呢，笨蛋！',
      'community.q3_title': '囊中羞涩可以白嫖吗？',
      'community.q3_ans': '当……当然可以！开源软件就是要大家用得开心！去 GitHub 给仓库点个免费的 🌟 Star，本开发者也会超级开心的啦！',
    ...
    en: {
      ...
      // Community & Sponsor Page (Tsundere Edition)
      'community.hero_badge': '(⁄ ⁄•⁄ω⁄•⁄ ⁄) Tsundere Dev\'s Secret Outpost',
      'community.hero_title': 'Hmph! It\'s not like I\'m begging for your support or anything!',
      'community.hero_subtitle': '(Turns away) Even if you don\'t buy me coffee, Wmimo will stay open-source and maintained forever, b-baka! But if you insist on buying me a treat... I guess I can accept it!',
      'community.dialogue_name': 'Tsundere Dev · Poke me!',
      'community.btn_poke': '👉 Poke',
      'community.sponsor_title': '💖 Secret Treat Channel',
      'community.sponsor_desc': 'If Wmimo actually helped you (not that I believe you), feel free to buy me coffee to power open-source coding... idiot!',
      ...
      'community.addr_copied': '(Blushes) Copied... it\'s not like I\'m super happy or anything!',
      'community.dev_email_label': '📬 Developer Email: ',
      'community.btn_send_email': 'Send Email',
      'community.tiers_title': '☕ Feeding Energy Tiers',
      'community.tier1_name': '1x Iced Americano',
      'community.tier1_price': '≈ 1.5 USDT',
      'community.tier1_buff1': '⚡ Bug fixing speed +20%',
      'community.tier1_buff2': '🧊 Tsundere level -5%',
      'community.tier1_quote': '"After drinking this coffee, maybe I\'ll fix an extra bug tonight..."',
      'community.tier2_name': '1x Boba Milk Tea',
      'community.tier2_price': '≈ 3.0 USDT',
      'community.tier2_buff1': '🚀 Multi-platform packaging drive +50%',
      'community.tier2_buff2': '✨ Drops secret updates & new features',
      'community.tier2_quote': '"It\'s not like I love sweets! My brain just needs sugar for coding!"',
      'community.tier3_name': 'Deluxe Afternoon Tea',
      'community.tier3_price': '≈ 10.0 USDT',
      'community.tier3_buff1': '💖 Stable heart rate, zero spaghetti code',
      'community.tier3_buff2': '🌟 Unlocks dev\'s eternal gratitude',
      'community.tier3_quote': '"Whoa... a-are you really treating me to this much?! T-Thank you..."',
      'community.qa_title': '💬 Tsundere Q&A Mini Theater',
      'community.q1_title': 'Do sponsors get VIP perks or ad removal?',
      'community.q1_ans': 'AB-SO-LUTELY NOT! Wmimo is 100% clean, open-source and ad-free forever! Everyone is treated equally! ...Although I might silently draw a little heart for you in my mind.',
      'community.q2_title': 'Why choose USDT on Aptos Network?',
      'community.q2_ans': 'Because Aptos transfer fees are like $0.0001—almost non-existent! I don\'t want you wasting hard-earned money on gas fees, dummy!',
      'community.q3_title': 'Can I just use it for free without donating?',
      'community.q3_ans': 'O-Of course you can! That\'s what open-source is for! Just starring the repo on 🌟 GitHub will make this developer super happy already!',
