...
(function() {
  ...
  const translations = {
    zh: {
      ...
      // Hero Section (Home)
      'hero.tag': '🚀 Wmimo v1.0.33 正式发布 · 全新 Meta 内核与 Bento 设计',
      'hero.title_pre': '极速、优雅、强大的',
      'hero.title_grad': '跨平台网络代理客户端',
      'hero.subtitle': '基于 Flutter 与 Mihomo 核心打造。提供全协议网络支持、TUN 虚拟网卡底层接管、全功能系统托盘与现代化 Bento 设计美学。',
      ...
      // Mockup UI
      'mockup.title': 'Wmimo 客户端 - 运行中',
      'mockup.status_connected': '已连接 · 极速分流中',
      'mockup.upload_label': '↑ 实时上行',
      'mockup.download_label': '↓ 实时下行',
      'mockup.mode_rule': '规则分流',
      'mockup.mode_global': '全局代理',
      'mockup.mode_direct': '直连模式',
      'mockup.active_node_title': '🇭🇰 香港 BGP 专线 01',
      'mockup.active_node_type': 'Hysteria 2 · 极速 UDP',
      'mockup.tun_label': 'TUN 虚拟网卡系统接管',
      'mockup.speed_test_btn': '⚡ 快速测速',

      // Install Strip
      'install.title': '极客终端一行指令安装：',
      'install.tab_winget': 'Windows (Winget)',
      'install.tab_scoop': 'Windows (Scoop)',
      'install.tab_yay': 'Arch Linux (AUR)',
      'install.tab_deb': 'Debian / Ubuntu',
      'install.tab_curl': '一键脚本 (Linux)',
      'install.copied': '安装指令已复制到剪贴板',

      // Bento Grid 2.0
      'bento.tag': 'ENGINEERED FOR PERFORMANCE',
      'bento.title': '专为极客打造的高性能网络引擎',
      'bento.subtitle': '深度融合 Flutter 现代渲染引擎与 Mihomo 底层协议栈，带来极致流畅与安心体验。',

      'bento.proto_title': '⚡ 新一代超低延迟全协议矩阵',
      'bento.proto_desc': '深度原生支持 Hysteria 2、TUIC v5、VLESS Reality 等协议，多路复用暴力抗丢包，弱网环境下依然秒开。',
      'bento.proto_hy2_desc': '基于 UDP 暴力抗丢包与动态拥塞控制',
      'bento.proto_tuic_desc': '0-RTT 极速握手，QUIC 底层加速',
      'bento.proto_reality_desc': '消除 TLS 指纹特征，深度防审查',
      'bento.proto_wireguard_desc': '内核级轻量化高速安全隧道',

      'bento.tun_title': '🛡️ TUN 虚拟网卡全局接管',
      'bento.tun_desc': '在系统底层创建高性能 Wintun 驱动，全面接管游戏客户端、终端命令行与 Docker 流量，内置 Fake-IP 防 DNS 污染。',
      'bento.tun_step1': '💻 原生应用 / 游戏 / 终端请求',
      'bento.tun_step2': '🛡️ Wintun 驱动 L3 虚拟网卡接管',
      'bento.tun_step3': '⚡ 智能 Fake-IP 防污染解析',
      'bento.tun_step4': '🌐 毫秒级低延迟出站出口',

      'bento.tray_title': '🔀 沉浸式全功能系统托盘',
      'bento.tray_desc': '常驻托盘动态展示上下行实时网速，右键快速切换分流模式、测速与复制终端代理环境变量。',
      'bento.tray_item1': '⚡ 切换分流模式 (Rule / Global / Direct)',
      'bento.tray_item2': '📊 打开实时流量与仪表盘监控',
      'bento.tray_item3': '📋 复制终端代理指令 (export http_proxy=...)',
      'bento.tray_item4': '🔄 检查并静默拉取订阅更新',

      'bento.stats_title': '🚀 极致轻量与原生性能',
      'bento.stats_desc': '告别臃肿的 Electron 架构，Flutter 原生编译实现极低内存占用与闪电启动。',
      'bento.stat1_label': '空闲待机内存开销',
      'bento.stat2_label': '冷启动极速就绪',
      'bento.stat3_label': '自由开源 GPL-3.0',
      'bento.stat4_label': '商业广告与后台常驻遥测',

      // Interactive Playground Simulator
      'play.tag': 'LIVE BENCHMARK SIMULATOR',
      'play.title': '体验全球节点毫秒级超快响应',
      'play.subtitle': '点击下方按钮即可模拟发起全球并发真实延迟探测，直观感受多节点智能调度策略。',
      'play.btn_start': '⚡ 开始并发测速探测',
      'play.node1_name': '🇭🇰 香港 Premium BGP 01',
      'play.node1_desc': 'HKT 商业带宽 · 极致低延迟',
      'play.node2_name': '🇯🇵 日本东京 CN2 GIA 02',
      'play.node2_desc': 'BGP 多线优化 · 4K 秒开',
      'play.node3_name': '🇸🇬 新加坡 AWS Cloud 01',
      'play.node3_desc': '东南亚节点 · 游戏竞技专线',
      'play.node4_name': '🇺🇸 美国洛杉矶 Anycast 03',
      'play.node4_desc': '跨洋骨干网 · 国际直达',
      'play.node5_name': '🇩🇪 德国法兰克福 Europe 01',
      'play.node5_desc': '欧洲核心中继枢纽',
    ...
    en: {
      ...
      // Hero Section (Home)
      'hero.tag': '🚀 Wmimo v1.0.33 Released · Powered by Meta & Bento Design',
      'hero.title_pre': 'Fast, Elegant, Powerful',
      'hero.title_grad': 'Cross-Platform Proxy Client',
      'hero.subtitle': 'Crafted with Flutter & Mihomo Core. Features full-protocol networking, system-level TUN virtual NIC take-over, full-featured system tray, and modern Bento design aesthetics.',
      ...
      // Mockup UI
      'mockup.title': 'Wmimo Client - Running',
      'mockup.status_connected': 'Connected · High-Speed Split',
      'mockup.upload_label': '↑ Realtime Upload',
      'mockup.download_label': '↓ Realtime Download',
      'mockup.mode_rule': 'Rule Mode',
      'mockup.mode_global': 'Global Mode',
      'mockup.mode_direct': 'Direct Mode',
      'mockup.active_node_title': '🇭🇰 Hong Kong BGP Direct 01',
      'mockup.active_node_type': 'Hysteria 2 · Turbo UDP',
      'mockup.tun_label': 'TUN Virtual Adapter System-wide',
      'mockup.speed_test_btn': '⚡ Quick Test',

      // Install Strip
      'install.title': 'Geek Terminal One-Liner Install:',
      'install.tab_winget': 'Windows (Winget)',
      'install.tab_scoop': 'Windows (Scoop)',
      'install.tab_yay': 'Arch Linux (AUR)',
      'install.tab_deb': 'Debian / Ubuntu',
      'install.tab_curl': 'Shell Script (Linux)',
      'install.copied': 'Install command copied to clipboard',

      // Bento Grid 2.0
      'bento.tag': 'ENGINEERED FOR PERFORMANCE',
      'bento.title': 'High-Performance Engine for Power Users',
      'bento.subtitle': 'Harmonizing modern Flutter rendering engine with Mihomo protocol stack for unmatched speed and privacy.',

      'bento.proto_title': '⚡ Next-Gen Ultra Low Latency Protocol Matrix',
      'bento.proto_desc': 'Deep native support for Hysteria 2, TUIC v5, VLESS Reality, WireGuard and more with aggressive packet loss resistance and instant handshake.',
      'bento.proto_hy2_desc': 'UDP-based packet loss mitigation & dynamic CC',
      'bento.proto_tuic_desc': '0-RTT handshake with QUIC acceleration',
      'bento.proto_reality_desc': 'Eliminates TLS fingerprinting signatures',
      'bento.proto_wireguard_desc': 'Kernel-level lightweight secure tunnel',

      'bento.tun_title': '🛡️ System-Level TUN Virtual NIC',
      'bento.tun_desc': 'Deploys high-throughput Wintun kernel driver to capture games, terminal CLI, and Docker traffic with Fake-IP anti-pollution DNS.',
      'bento.tun_step1': '💻 Apps / Games / Terminal CLI',
      'bento.tun_step2': '🛡️ Wintun L3 Virtual NIC Capture',
      'bento.tun_step3': '⚡ Smart Fake-IP Anti-Pollution',
      'bento.tun_step4': '🌐 Sub-millisecond Outbound Routing',

      'bento.tray_title': '🔀 Immersive Full-Featured Taskbar Tray',
      'bento.tray_desc': 'Live upload/download speed monitoring in tray. One-click right-click menu to switch routing modes, run benchmarks, and copy proxy environment variables.',
      'bento.tray_item1': '⚡ Switch Routing Mode (Rule / Global / Direct)',
      'bento.tray_item2': '📊 Open Real-Time Traffic & Web Dashboard',
      'bento.tray_item3': '📋 Copy Terminal Proxy Command (export http_proxy=...)',
      'bento.tray_item4': '🔄 Check & Silently Update Subscriptions',

      'bento.stats_title': '🚀 Ultra Lightweight & Native Performance',
      'bento.stats_desc': 'No bloated Electron runtime. Native Flutter compilation ensures minimal memory footprint and instant cold startup.',
      'bento.stat1_label': 'Idle RAM Footprint',
      'bento.stat2_label': 'Cold Start Ready Time',
      'bento.stat3_label': '100% Free Open Source',
      'bento.stat4_label': 'Zero Ads & Zero Telemetry',

      // Interactive Playground Simulator
      'play.tag': 'LIVE BENCHMARK SIMULATOR',
      'play.title': 'Experience Global Sub-Millisecond Response',
      'play.subtitle': 'Click below to simulate concurrent global ping latency checks and see intelligent policy routing in action.',
      'play.btn_start': '⚡ Start Concurrent Ping Benchmark',
      'play.node1_name': '🇭🇰 Hong Kong Premium BGP 01',
      'play.node1_desc': 'HKT Commercial · Ultra Low Latency',
      'play.node2_name': '🇯🇵 Tokyo CN2 GIA Premium 02',
      'play.node2_desc': 'Multi-homed BGP · 4K Instant Stream',
      'play.node3_name': '🇸🇬 Singapore AWS Cloud 01',
      'play.node3_desc': 'SE Asia Hub · Gaming Dedicated Line',
      'play.node4_name': '🇺🇸 Los Angeles Anycast 03',
      'play.node4_desc': 'Trans-Pacific Backbone · Direct Route',
      'play.node5_name': '🇩🇪 Frankfurt Europe Core 01',
      'play.node5_desc': 'Central European Transit Hub',
