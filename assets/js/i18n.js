...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'hero.legacy_btn_download': '下载客户端',
      'hero.btn_docs': '快速上手',
      ...
      // Folia Aesthetic Home Redesign (ZH)
      'typo.line2': '虚空贯通 · 极速分流',
      'typo.line4': '穿越迷雾与重构链路',
      'typo.line6': '无界漫游 · 自由而行',
      'folia.hero_subtitle': 'Proxy Reimagined.',
      'folia.btn_download': '立即下载',
      'folia.btn_docs': '查看文档',
      'folia.btn_github': 'GitHub 仓库',
      'folia.scroll_explore': '向下滑动探索',
      'folia.s1_title': '沉浸式内核与极速分流',
      'folia.s1_desc': '打破传统网络代理工具的枯燥与繁杂，Wmimo 将连接速度与稳定性作为视觉交互的核心。深度集成轻量高效的 Mihomo 核心，提供微秒级规则分流与全协议透传，让每一次网络漫游都如行云流水。',
      'folia.s1_mock1_title': '智能规则与微秒级分流',
      'folia.s1_mock1_badge': 'Mihomo Meta 内核驱动',
      'folia.s1_mock2_title': '低延迟多路复用 Multiplex',
      'folia.s1_mock2_badge': '极低资源占用 · 零抖动',
      'folia.s1_mock3_title': '现代化跨平台交互体验',
      'folia.s1_mock3_badge': '原生 Flutter 桌面与移动端',
      'folia.s2_title': '简洁专注，远离臃肿',
      'folia.s2_desc': '没有打扰注意力的弹窗、繁杂的参数堆砌或任何无用冗余，Wmimo 的视线始终聚焦于连接与效率。全功能系统托盘常驻后台，轻点右键即可秒级切换模式、测速与复制代理命令，让强大隐藏于极简之中。',
      'folia.s2_c1_tag': 'ZERO BLOATWARE',
      'folia.s2_c1_title': '零广告 · 秒速冷启',
      'folia.s2_c2_tag': 'DESIGN SYSTEM',
      'folia.s2_c2_title': '18px 微卡片设计美学',
      'folia.s2_c3_tag': 'SYSTEM TRAY',
      'folia.s2_c3_title': '原生托盘与实时网速',
      'folia.s3_title': '跨平台原生覆盖',
      'folia.s3_desc': '全端一致的高品质使用体验。无论是 Windows 10/11 的桌面生产力环境，Linux 各大主流发行版（Debian / Ubuntu / Arch / Fedora），还是搭载不同架构处理器的 Android 手机与电视盒子，均提供高度优化的原生构建版本。',
      'folia.s4_title': 'TUN 虚拟网卡系统级接管',
      'folia.s4_desc': '在操作系统底层建立虚拟网络适配器，实现全局透明捕获。无需繁复配置每个软件的代理端口，终端命令行、大型网络游戏、后台 Docker 服务与所有原生应用皆能即刻享受极速加速。左右拖拽查看两端对比：',
      'folia.s4_base_heading': '普通直连 / 基础代理',
      'folia.s4_over_heading': 'Wmimo TUN 虚拟网卡',
      'folia.s4_label_left': 'Wmimo TUN 模式',
      'folia.s4_label_right': '常规普通直连',
      'folia.s5_title': '现代多协议矩阵',
      'folia.s5_desc': '全协议栈深度支持。针对复杂异构网络环境，Wmimo 集成了基于 UDP 的下一代抗拥塞协议与伪装穿透方案。无论是低延时视讯通话、高通量 4K 串流，还是大文件并发传输，皆能从容应对。',
      'folia.cta_title': '开启无界漫游之旅',
      'folia.cta_desc': '立即免费下载 Wmimo，体验极致速度、优雅界面与强大的系统级网络掌控力。',
      'folia.btn_download_now': '下载客户端',
      'folia.btn_docs_quick': '查看使用文档',
      'folia.btn_speedtest': '在线网络测速',
      ...
      'community.hero_subtitle': 'Wmimo 始终坚持 100% 自由开源、零商业广告与全平台免费。赞助纯属自愿心意，金额完全不设限；您的每一份鼓励，都将直接化为项目持续维护与优化的动力。',
      'community.dialogue_name': '开发者心声 · 点击互动',
      'community.btn_poke': '💡 换一句',
      'community.voluntary_notice': '💡 温馨提示：赞助金额全凭个人心意，完全不设任何门槛与限制。无论是 0.1 USDT 还是单纯的一句鼓励，都对开源维护有着巨大的意义！',
      'community.sponsor_title': '💖 加密货币赞助通道',
      'community.sponsor_desc': '赞助完全自愿且不设任何金额门槛，无论数额多少都是对开源作者莫大的认可。如果 Wmimo 提升了您的网络与工作效率，欢迎随心请作者喝杯咖啡。',
      ...
      'community.addr_copied': '收款地址已复制到剪贴板，非常感谢您的心意与支持！',
      'community.dev_email_label': '📬 开发者联系邮箱：',
      'community.btn_send_email': '发送邮件',
      'community.tiers_title': '☕ 随心支持 · 赞助方向参考（金额不设限）',
      'community.tier1_name': '单份浓缩 (Espresso)',
      'community.tier1_price': '金额随意 · 随心支持',
      ...
      'community.tier2_price': '金额随意 · 随心支持',
      ...
      'community.tier3_price': '金额随意 · 随心支持',
      ...
      'community.q1_title': '赞助是否有金额要求或特权限制？',
      'community.q1_ans': '完全没有金额要求！赞助纯属心意与自愿，金额大小随意不设限。同时 Wmimo 坚持 100% 自由开源，所有功能对全球用户完全开放，绝无 VIP 锁区或区别对待。',
      ...
      'docs.item_subscriptions': '订阅管理与远程规则集',
      ...
      'doc_sub.title': "订阅管理与远程规则集 (Providers)",
      'doc_sub.subtitle': "深入掌握 Proxy Providers 节点集合并、Rule Providers 远程规则订阅、自动更新策略与 Geo 数据库维护。",
      'doc_sub.intro_callout': "💡 <strong>什么是 Provider？</strong> Provider（提供者）是 Mihomo / Clash 核心中用于实现配置模块化与解耦的强大特性。通过 Provider，您可以将节点列表与分流规则托管在外部远程链接或独立本地文件中，实现多订阅动态合并与无人值守静默自动更新。",
      'doc_sub.h2_proxy_providers': "📦 1. 代理集合 (Proxy Providers)",
      'doc_sub.proxy_providers_desc': "Proxy Providers 允许从一个或多个机场订阅链接动态拉取节点，并自动进行本地缓存与健康检查。策略组可以直接引用 Provider 包含的全部节点：",
      'doc_sub.h2_rule_providers': "🛡️ 2. 远程分流规则集 (Rule Providers)",
      'doc_sub.rule_providers_desc': "Rule Providers 让你无需在主配置文件中手写成千上万行规则，而是直接订阅由社区（如 Loyalsoldier、MetaCubeX 等）每日维护的高精度分流集：",
      'doc_sub.h2_rules_apply': "🔗 3. 在 Rules 中引用 Provider 规则",
      'doc_sub.rules_apply_desc': "在 rules: 段中使用 RULE-SET 指令引用已定义的 Rule Provider：",
      'doc_sub.h2_geo_db': "🌍 4. GeoIP 与 GeoSite 数据库自动更新",
      ...
      // SpeedTest Page
      'st.hero_title': '在线速度测试',
      'st.hero_subtitle': '一键测试您的网络连接质量 · 精准 · 可靠 · 全球节点',
      ...
      'st.phase_down': '下载速度',
      'st.phase_up': '上传速度',
      'st.phase_finished': '测试完成',
      'st.server_connected': '已连接最佳节点',
      'st.global_nodes': '全球 300+ 节点',
      'st.global_nodes_sub': '自动选择最优边缘',
      'st.step_conn': '连接服务器',
      'st.step_ping': '测试延迟',
      'st.step_down': '测试下载速度',
      'st.step_up': '测试上传速度',
      'st.step_quality': '分析网络质量',
      'st.status_ready': '已就绪',
      'st.status_running': '进行中...',
      'st.status_waiting': '等待中...',
      'st.metric_ping': '延迟 (Ping)',
      'st.metric_ping_sub': '网络响应时间',
      'st.metric_jitter': '抖动 (Jitter)',
      'st.metric_jitter_sub': '延迟波动',
      'st.metric_down': '下载速度',
      'st.metric_down_sub': '当前下载速率',
      'st.metric_up': '上传速度',
      'st.metric_up_sub': '当前上传速率',
      'st.chart_title': '实时速度',
      'st.legend_download': '下载',
      'st.legend_upload': '上传',
      'st.tested_data': '已测试',
      'st.quality_title': '网络质量：',
      'st.quality_excellent': '极佳',
      'st.quality_good': '良好',
      'st.quality_fair': '一般',
      'st.quality_desc_excellent': '您的网络连接极其优异，享受极致超低延迟体验。',
      'st.quality_desc_good': '您的网络连接非常稳定，满足日常使用需求。',
      'st.quality_desc_fair': '网络连接基本正常，部分高负载场景可能略有波动。',
      'st.tag_4k': '4K 视频',
      'st.tag_conf': '视频会议',
      'st.tag_gaming': '在线游戏',
      'st.tag_download': '大文件下载',
      'st.net_info_title': '网络信息',
      'st.net_ip': '公网 IP',
      'st.net_node': '测试节点',
      'st.net_proto': '协议',
      'st.net_tls': 'TLS 版本',
      ...
      'st.btn_switch_server': '更换服务器',
      'st.select_server_title': '选择测速服务器与节点',
      'st.server_auto_title': '全球 Anycast 边缘优选',
      'st.server_auto_desc': 'Cloudflare 300+ 城市全球网络 · 自动选路',
      'st.server_apac_title': '亚太边缘节点群 (中国香港 / 日本 / 新加坡)',
      'st.server_apac_desc': '亚太骨干直连 · 低延迟优质边缘路由',
      'st.server_na_title': '北美核心节点群 (美西圣何塞 / 洛杉矶)',
      'st.server_na_desc': '硅谷与美西大型数据中心 · 高带宽吞吐',
      'st.server_eu_title': '欧洲核心节点群 (法兰克福 / 伦敦)',
      'st.server_eu_desc': '欧洲核心交换中心 DE-CIX 骨干节点',
      'st.probing': '测延迟...',
      'st.reprobe': '重新探测',
    ...
    en: {
      ...
      // Folia Aesthetic Home Redesign (EN)
      'typo.line2': 'PIERCING THE VOID, ULTRA SPEED',
      'typo.line4': 'THROUGH THE MIST, REBUILDING PATHS',
      'typo.line6': 'BOUNDLESS ROAMING, WALK IN FREEDOM',
      'folia.hero_subtitle': 'Proxy Reimagined.',
      'folia.btn_download': 'Download Now',
      'folia.btn_docs': 'Documentation',
      'folia.btn_github': 'GitHub Repo',
      'folia.scroll_explore': 'Scroll Down to Explore',
      'folia.s1_title': 'Immersive Core & Smart Routing',
      'folia.s1_desc': 'Breaking the bloat of traditional proxy tools, Wmimo puts raw speed and seamless stability at the center of its experience. Built on top of the ultra-fast Mihomo core, it delivers microsecond rule routing and transparent protocol passing.',
      'folia.s1_mock1_title': 'Smart Rules & Microsecond Routing',
      'folia.s1_mock1_badge': 'Mihomo Meta Kernel Inside',
      'folia.s1_mock2_title': 'Low-Latency Multiplexing',
      'folia.s1_mock2_badge': 'Ultra-Low Footprint · Jitter-Free',
      'folia.s1_mock3_title': 'Modern Cross-Platform UX',
      'folia.s1_mock3_badge': 'Native Flutter Desktop & Mobile',
      'folia.s2_title': 'Pure Simplicity, Zero Bloat',
      'folia.s2_desc': 'No distracting popups, bloated UI, or endless complex options. Wmimo stays focused solely on connection and efficiency. Full-featured system tray stays lean in the background for quick mode toggling, benchmarking, and proxy copying.',
      'folia.s2_c1_tag': 'ZERO BLOATWARE',
      'folia.s2_c1_title': 'Zero Ads · Instant Startup',
      'folia.s2_c2_tag': 'DESIGN SYSTEM',
      'folia.s2_c2_title': '18px Micro-Card Aesthetic',
      'folia.s2_c3_tag': 'SYSTEM TRAY',
      'folia.s2_c3_title': 'Native Tray & Live Bandwidth',
      'folia.s3_title': 'Universal Native Deployment',
      'folia.s3_desc': 'Consistent, premium experience across all platforms. Tailored native binaries for Windows 10/11 x64/ARM64, major Linux distros (Deb/RPM/Arch), and full-architecture Android phones and smart TVs.',
      'folia.s4_title': 'Low-Level TUN System Takeover',
      'folia.s4_desc': 'Establishes a virtual network adapter at the OS kernel level for global transparent capture. No manual proxy configurations needed—terminal CLI, games, Docker containers, and native apps are accelerated instantly. Drag slider to compare:',
      'folia.s4_base_heading': 'Direct Network / Basic Proxy',
      'folia.s4_over_heading': 'Wmimo TUN Virtual Adapter',
      'folia.s4_label_left': 'Wmimo TUN Mode',
      'folia.s4_label_right': 'Direct Connection',
      'folia.s5_title': 'Cutting-Edge Protocol Matrix',
      'folia.s5_desc': 'Full protocol stack support. Purpose-built for complex network environments, integrating next-gen UDP-based congestion control and advanced camouflage. Flawless for real-time gaming, 4K streaming, and multi-threaded transfers.',
      'folia.cta_title': 'Begin Your Journey of Boundless Speed',
      'folia.cta_desc': 'Download Wmimo today for free and experience blistering speed, refined aesthetics, and effortless network control.',
      'folia.btn_download_now': 'Download Client',
      'folia.btn_docs_quick': 'Documentation',
      'folia.btn_speedtest': 'Online Speedtest',
      ...
      'community.hero_subtitle': 'Wmimo is committed to 100% free open-source, zero ads, and multi-platform accessibility. Sponsorship is entirely voluntary with no set amounts; every gesture of support fuels ongoing maintenance.',
      'community.dialogue_name': 'Developer Voice · Click to Interact',
      'community.btn_poke': '💡 Refresh',
      'community.voluntary_notice': '💡 Friendly Reminder: Sponsorship is completely voluntary with zero minimums or restrictions. Whether it\'s 0.1 USDT or simply a warm message of encouragement, every bit of support is deeply cherished!',
      'community.sponsor_title': '💖 Crypto Sponsorship Channel',
      'community.sponsor_desc': 'Contributions are entirely voluntary with zero minimums or fixed amounts. If Wmimo has enhanced your experience, feel free to buy the author a coffee of any custom amount.',
      ...
      'community.tiers_title': '☕ Voluntary Support · Direction Reference (No Set Amounts)',
      'community.tier1_name': 'Single Espresso',
      'community.tier1_price': 'Any Amount · Voluntary',
      ...
      'community.tier2_price': 'Any Amount · Voluntary',
      ...
      'community.tier3_price': 'Any Amount · Voluntary',
      ...
      'community.q1_title': 'Is there any minimum donation amount or locked feature?',
      'community.q1_ans': 'No required amounts at all! Contributions are 100% voluntary with zero minimums. Wmimo remains 100% free and open-source for everyone with no VIP restrictions.',
      ...
      'docs.item_subscriptions': 'Subscriptions & Rule Providers',
      ...
      'doc_sub.title': "Subscription Management & Rule Providers",
      'doc_sub.subtitle': "Master Proxy Providers merging, Rule Providers remote subscriptions, automatic update intervals, and Geo database maintenance.",
      'doc_sub.intro_callout': "💡 <strong>What is a Provider?</strong> Providers in Mihomo / Clash enable modular, decoupled configurations. They allow you to manage proxy nodes and routing rules via remote URLs or standalone files with automatic background updating and multi-subscription merging.",
      'doc_sub.h2_proxy_providers': "📦 1. Proxy Providers (Node Sets)",
      'doc_sub.proxy_providers_desc': "Proxy Providers dynamically fetch nodes from subscription links with local caching and health checks. Policy groups can directly reference all nodes from a provider:",
      'doc_sub.h2_rule_providers': "🛡️ 2. Rule Providers (Remote Rule Sets)",
      'doc_sub.rule_providers_desc': "Rule Providers eliminate handwritten lists by subscribing directly to community-maintained high-precision rulesets (Loyalsoldier, MetaCubeX, etc.):",
      'doc_sub.h2_rules_apply': "🔗 3. Referencing Providers in Rules",
      'doc_sub.rules_apply_desc': "Use the RULE-SET directive in the rules: section to route traffic according to provider rulesets:",
      'doc_sub.h2_geo_db': "🌍 4. Automated GeoIP & GeoSite Database Updates",
      ...
      'st.hero_subtitle': 'One-click test of your network connection quality · Accurate · Reliable · Global Nodes',
      'st.badge_live': '⚡ Global Anycast Edge Benchmark',
      'st.btn_start': 'Start Test',
      'st.btn_testing': 'Testing...',
      'st.btn_stop': 'Stop Test',
      'st.phase_idle': 'STANDBY',
      'st.phase_ping': 'Ping Testing',
      'st.phase_down': 'Download',
      'st.phase_up': 'Upload',
      'st.phase_finished': 'Finished',
      'st.server_connected': 'Best Node Connected',
      'st.global_nodes': '300+ Global Nodes',
      'st.global_nodes_sub': 'Auto-route to optimal edge',
      'st.step_conn': 'Connect Server',
      'st.step_ping': 'Test Latency',
      'st.step_down': 'Test Download',
      'st.step_up': 'Test Upload',
      'st.step_quality': 'Analyze Quality',
      'st.status_ready': 'Ready',
      'st.status_running': 'Testing...',
      'st.status_waiting': 'Waiting...',
      'st.metric_ping': 'Latency (Ping)',
      'st.metric_ping_sub': 'Network Response Time',
      'st.metric_jitter': 'Jitter',
      'st.metric_jitter_sub': 'Latency Variance',
      'st.metric_down': 'Download Speed',
      'st.metric_down_sub': 'Current Download Rate',
      'st.metric_up': 'Upload Speed',
      'st.metric_up_sub': 'Current Upload Rate',
      'st.chart_title': 'Real-time Speed',
      'st.legend_download': 'Download',
      'st.legend_upload': 'Upload',
      'st.tested_data': 'Tested',
      'st.quality_title': 'Network Quality: ',
      'st.quality_excellent': 'Excellent',
      'st.quality_good': 'Good',
      'st.quality_fair': 'Fair',
      'st.quality_desc_excellent': 'Your network connection is ultra-fast with minimal latency.',
      'st.quality_desc_good': 'Your network connection is very stable, perfect for daily needs.',
      'st.quality_desc_fair': 'Network connection is functional, minor jitter under load.',
      'st.tag_4k': '4K Video',
      'st.tag_conf': 'Video Calls',
      'st.tag_gaming': 'Online Gaming',
      'st.tag_download': 'Large Downloads',
      'st.net_info_title': 'Network Information',
      'st.net_ip': 'Public IP',
      'st.net_node': 'Test Node',
      'st.net_proto': 'Protocol',
      'st.net_tls': 'TLS Version',
      'st.net_isp': 'ISP',
      'st.chart_peak': 'Peak Bandwidth',
      ...
      'st.btn_switch_server': 'Switch Server',
      'st.select_server_title': 'Select SpeedTest Server Node',
      'st.server_auto_title': 'Global Anycast (Auto Best)',
      'st.server_auto_desc': 'Cloudflare 300+ Global Cities · Auto-Routed',
      'st.server_apac_title': 'APAC Edge Group (Hong Kong / Tokyo / Singapore)',
      'st.server_apac_desc': 'Asia-Pacific Core Backbone · Low Latency Routing',
      'st.server_na_title': 'North America Core Group (San Jose / Los Angeles)',
      'st.server_na_desc': 'US West Coast High-Capacity Datacenters',
      'st.server_eu_title': 'Europe Core Group (Frankfurt / London)',
      'st.server_eu_desc': 'European Central Exchange Backbone Nodes',
      'st.probing': 'Probing...',
      'st.reprobe': 'Re-probe',
